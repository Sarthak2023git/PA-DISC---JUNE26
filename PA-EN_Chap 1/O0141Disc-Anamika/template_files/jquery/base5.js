$(document).ready(function(){
 ...
 if(String(navigator.userAgent).indexOf("Edge") != -1){
	...
	$(".handMainBtn").css({"font-size" : 36+"px" , "margin-top" : -80+"px"});
	
	}else if((window.width1 >= 1301 && window.width1 <= 1500)){  
	
	$(".handMainBtn").css({"font-size" : 35+"px" , "margin-top" : -74+"px"});
	
	}else if((window.width1 >= 1501 && window.width1 <= 1800)){  
	
	$(".handMainBtn").css({"font-size" : 46+"px" , "margin-top" : -110+"px"});
	
	}else if((window.width1 >= 1801 && window.width1 <= 2000)){ 
	
	$(".handMainBtn").css({"font-size" : 50+"px" , "margin-top" : -115+"px"});
