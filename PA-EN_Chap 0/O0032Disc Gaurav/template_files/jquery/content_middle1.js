...
$(document).ready(function(){
	...
	if(hk < hk1){
		...
		$(".middle2").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		...
		$(".middle7").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		$(".middle8").css("margin-top",0+"px")
					} else {
		$(".middle8").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle8").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle8").css("margin-top",mar+"px")
			} else {
		$(".middle8").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
						   ...
						   $(".fourth_button").click(function(){
																 ...
																 if(hk < hk1){
																	  $(".middle9").css("margin-top",0+"px")
																 }
																 else
																 {
																	 $(".middle9").css("margin-top",5+"px")
																 }
													
																  $(".Content00").show();
																 var hk=$(".middle9").height();
																 var hk1=$(".container-right").height();
																 
																 var mar = (hk1-hk)/2;
																 if(hk < hk1){
																 $(".middle9").css("margin-top",mar+"px")
																 }
																 $(".Content00").hide();
																 })
	...
	if(hk < hk1){
		$(".middle10").css("margin-top",0+"px")
					} else {
		$(".middle10").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle10").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle10").css("margin-top",mar+"px")
			} else {
		$(".middle10").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		$(".middle11").css("margin-top",0+"px")
					} else {
		$(".middle11").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle11").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle11").css("margin-top",mar+"px")
			} else {
		$(".middle11").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		$(".middle12").css("margin-top",0+"px")
					} else {
		$(".middle12").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle12").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle12").css("margin-top",mar+"px")
			} else {
		$(".middle12").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		$(".middle13").css("margin-top",0+"px")
					} else {
		$(".middle13").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle13").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle13").css("margin-top",mar+"px")
			} else {
		$(".middle13").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
							  ...
							  $(".fifth_button").click(function(){
																 ...
																 if(hk < hk1){
																	  $(".middle14").css("margin-top",0+"px")
																 }
																 else
																 {
																	 $(".middle14").css("margin-top",5+"px")
																 }
													
																  $(".Content00").show();
																 var hk=$(".middle14").height();
																 var hk1=$(".container-right").height();
																 
																 var mar = (hk1-hk)/2;
																 if(hk < hk1){
																 $(".middle14").css("margin-top",mar+"px")
																 }
																 $(".Content00").hide();
																 })
	...
	if(hk < hk1){
		$(".middle17").css("margin-top",0+"px")
					} else {
		$(".middle17").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle17").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle17").css("margin-top",mar+"px")
			} else {
		$(".middle17").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
	...
	if(hk < hk1){
		$(".middle18").css("margin-top",0+"px")
					} else {
		$(".middle18").css("margin-top",5+"px")
					}
					
	$(".Content00").show().css("inline-block");
	var hk=$(".middle18").height();
	var hk1=$(".container-right").height();
	var hk2 = $(".buttons1").height();
	var mar = (hk1-hk-hk2 )/2;
	mar = mar+hk2
	...
	if(hk < hk1){
		$(".middle18").css("margin-top",mar+"px")
			} else {
		$(".middle18").css("margin-top",hk2+5+"px")
			}
		$(".Content00").hide();
	});
